...
class GreaterThanTest extends TestCase
{
    ...
    {
        $this->assertSame('gt', $this->operator->getCode());
        $this->assertSame('greater than', (string)$this->operator->getLabel());
    }
    ...
    public static function evaluateProvider(): array
    {
        return [
            ...
            'int equal' => [3, '3', false],
            'int less' => [2, '3', false],
            'float compare' => [3.14, '3.1', true],
            'non-numeric config' => [5, 'abc', false],
            'null treated as 0' => [null, '-1', true],
            'null vs 0' => [null, '0', false],
            'string field coerced' => ['42', '40', true],
        ];
    }
}
