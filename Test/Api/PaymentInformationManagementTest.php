...
/**
 * Verifies that the customer place-order REST endpoint is guarded by the
 * Hryvinskyi InvisibleCaptcha module when `place_order` form protection is on.
 *
 * Mirrors {@see \Magento\ReCaptchaCheckout\Test\Api\PaymentInformationManagementTest}
...
class PaymentInformationManagementTest extends WebapiAbstract
{
    ...
    protected function setUp(): void
    {
        ...
        $this->tokenService = $this->objectManager->get(CustomerTokenServiceInterface::class);
